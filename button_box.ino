...
rotariesdef rotaries[NUMROTARIES] {
  {0,1,25,26,0}, //rotary 1
  {2,3,27,28,0}, //rotary 2
  {4,5,29,30,0}, //rotary 3
...
byte rowPins[NUMROWS] = {21,20,19,18,15,14}; //change "?" to the pins the rows of your button matrix are connected to
byte colPins[NUMCOLS] = {16,10,9,8,7}; //change "?" to the pins the rows of your button matrix are connected to
